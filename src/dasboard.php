            ...
            <div class="card border-left-primary shadow h-100 py-2 bg-warning">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-black text-uppercase mb-1">Usuarios</div>
                            <div class="h5 mb-0 font-weight-bold text-black"><?php echo $totalU; ?></div>
                        </div>
                        <div class="col-auto">
        ...
        <a class="col-xl-3 col-md-6 mb-4" href="clientes.php">
            <div class="card border-left-warning shadow h-100 py-2 bg-warning">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-black text-uppercase mb-1">Clientes</div>
                            <div class="h5 mb-0 font-weight-bold text-black"><?php echo $totalC; ?></div>
                        </div>
                        <div class="col-auto">
        ...
        <a class="col-xl-3 col-md-6 mb-4" href="productos.php">
            <div class="card border-left-info shadow h-100 py-2 bg-warning">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-black text-uppercase mb-1">Productos</div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-black"><?php echo $totalP; ?></div>
                                </div>
                                <div class="col">
        ...
        <a class="col-xl-3 col-md-6 mb-4" href="ventas.php">
            <div class="card border-left-warning bg-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-black text-uppercase mb-1">Ventas</div>
                            <div class="h5 mb-0 font-weight-bold text-black"><?php echo $totalV; ?></div>
                        </div>
                        <div class="col-auto">
